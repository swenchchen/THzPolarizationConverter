...
% Each following group is to plot the output phase for a target center
% frequency, corresponding to the four target polarization states.
% the d_gap and delta_t values are given by running the above code
